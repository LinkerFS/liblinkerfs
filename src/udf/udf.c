...
static void content_inline_num_warp_targets(const UDF_WARP_TARGET *udf_warp_target,
    ...
    warp_target_helper->data_length =
            udf_warp_target->size_to_read > left_size ? left_size : udf_warp_target->size_to_read;
...
static void content_parts_num_warp_targets(const UDF_WARP_TARGET *udf_warp_target,
    ...
    warp_target_helper->content_parts.data_end_relative_offset =
            part->length - (read_size - udf_warp_target->size_to_read);
...
static const struct udf_file_info_handler content_inline_handler = {.num_warp_targets = content_inline_num_warp_targets,
                                                                    .convert_warp_target = content_inline_warp_convert};

static const struct udf_file_info_handler content_parts_handler = {.num_warp_targets = content_parts_num_warp_targets,
...
WARP_FILE udf_generate_warp_file(const UDF_WARP_CONFIG *udf_warp_config) {
    ...
    free(helper_array);
    const WARP_CONFIG warp_config = {.warp_count = num_warp_targets, .warp_targets = warp_targets};
